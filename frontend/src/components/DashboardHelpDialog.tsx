      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <h2 className="mt-1 text-base font-extrabold text-slate-900">Account Setup & Sign-in Help</h2>
            <p className="mt-1 text-xs text-slate-600">How to activate your account and regain access.</p>
          </div>
          <button
            type="button"
            onClick={onClose}
